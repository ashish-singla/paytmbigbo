...
function register_new_user( $user_login, $user_email ) {
	...
	//new function
       ...
       /* $siteUrl = get_site_url();*/
        ...
        $subject =  "Paytmgobig Successful Registration ";
        
        $message  = "Dear ".$sanitized_user_login."\r\n\r\n";
        $message .= "You have successfully registered on ".get_site_url()."\r\n\r\n";
        $message .= "Kindly use the below-mentioned credentials to login to your account:-"."\r\n\r\n";
        $message .= 'Username: '.$sanitized_user_login."\r\n\r\n";
        $message .= 'Password: '.$user_pass."\r\n\r\n";
        $message .= 'Thank You'."\r\n";
		$message .= 'Merchant Management Team'."\r\n";
		$message .=	'#Paytmkaro'."\r\n";

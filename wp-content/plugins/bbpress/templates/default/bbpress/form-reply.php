...
<?php else : ?>
	...
	<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
		<div class="bbp-template-notice">
			...
			<p><?php is_user_logged_in() ? _e( 'You cannot reply to this topic.', 'bbpress' ) : _e( 'You must be logged in to reply to this topic.', 'bbpress' );?><?php if(!is_user_logged_in()){ ?>Click here to <a href="<?php echo wp_login_url(); ?>" title="Login">Login</a>/<a href="<?php echo wp_registration_url(); ?>">Register</a> <?php } ?> </p>

...
<?php else : ?>
	...
	<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
		<div class="bbp-template-notice">
			<p><?php is_user_logged_in() ? _e( 'You cannot create new forums.', 'bbpress' ) : _e( 'You must be logged in to create new forums.', 'bbpress' ); ?><?php if(!is_user_logged_in()){ ?>Click here to <a href="<?php echo wp_login_url(); ?>" title="Login">Login</a>/<a href="<?php echo wp_registration_url(); ?>">Register</a> <?php } ?> </p>
		</div>
	</div>

...
class BBP_Topics_Widget extends WP_Widget {
	...
	public function widget( $args = array(), $instance = array() ) {
		...
		<ul class="trending-pad" style="margin-top:27px">
			...
			<?php while ( $widget_query->have_posts() ) :
				...
				<li class="trend-pad-bottom" style="margin-bottom:10px">
					...
					<?php endif; ?>
					<hr size="1px" style="display: block;background-color: #DCDCDC;border-style: inset;border-width: 0px;" />

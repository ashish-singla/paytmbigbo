	...
	public function include_scripts () {
		...
		wp_localize_script("app-locations", '_app_locations_data', apply_filters('app-locations-location_model_template', array(
			'model' => array(
				...
				'labels' => array(
					'add_locationcity' => __('Add', 'appointments'),
					'save_location' => __('Save', 'appointments'),
					'new_location' => __('Create a New Locationcity', 'appointments'),
					'edit_location' => __('Edit Locationcity', 'appointments'),

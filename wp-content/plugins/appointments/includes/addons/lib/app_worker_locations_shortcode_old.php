...
class App_Shortcode_WorkerLocationsShortcode extends App_Shortcode {
	...
	public function process_shortcode ($args=array(), $content='') {
		...
		$ret .= '<input type="text" name="app_provider_location10" class="app_service_location_10" id="app_service_location_10" value="'.$sel_city.'" list="location-datalist-id" placeholder="Select City" autofocus />';
		...
		$ret .= '<input type="text" name="app_provider_location_2" class="app_service_location_2" id="app_service_location_2" value="'.$sel_city.'" list="area-datalist-id" placeholder="Select Area" autofocus />';
